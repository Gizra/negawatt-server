...
/**
 * @file NegawattPaymentMigrate.php
 * Contains \NegawattPaymentMigrate.
 */

class NegawattPaymentMigrate extends Migration {

  public $entityType = 'payment';
  ...
  public function __construct() {
    ...
    if ($sql_migrate) {
      // SQL migration.
      $query = db_select('_negawatt_payment_normalized_migrate', $this->bundle)
